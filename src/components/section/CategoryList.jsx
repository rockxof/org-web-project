...
const CategoryList = () => {
  ...
  return (
    <div className="grid alpe grid-cols-4 w-full gap-10 justify-items-center mt-8">
        <div onClick={() => navigate('/voters-list')} className="grid-box w-48 text-center rounded-xl font-bold p-4 bg-red-400">Voters Lists</div>
        <div className="grid-box w-48 text-center rounded-xl font-bold p-4 bg-violet-400">Family Wise List</div>
        <div className="grid-box w-48 text-center rounded-xl font-bold p-4 bg-blue-600">Caste Wise List</div>
        <div className="grid-box w-48 text-center rounded-xl font-bold p-4 bg-yellow-600">Age Wise List</div>
